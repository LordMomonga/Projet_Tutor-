  ...
  return (
    <div className="subgrid-two-item grid-common grid-c6">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Notation</h3>
                        ...
                        <div className="grid-item" key = { saving.id }>
                            <div className="grid-item-top">
                                <div className="grid-item-top-l">
                                    <div className="avatar img-fit-cover bg-white">
                                    </div>
                            ...
                            <div className="grid-item-bottom">
                                <div className="grid-item-badges">
                                    ...
                                    <span className="grid-item-badge">notation moyenne  { saving.amount_left }</span>
                                </div>
