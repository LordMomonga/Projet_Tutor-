        ...
        <form className="space-y-4 md:space-y-6 border-2 border-transparent dark:border-secondary/50 dark:bg-white bg-tertiary p-5 sm:p-10 max-w-xs rounded-xl sm:max-w-lg" onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input
                    ...
                    className={`${errors.password && "!border-red-500"} dark:bg-gray-50 bg-transparent border border-secondary/40 focus:border-secondary outline-none dark:text-white sm:text-sm rounded-lg block w-full p-2.5`}
                />
